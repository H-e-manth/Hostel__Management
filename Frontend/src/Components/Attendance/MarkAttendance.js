        ...
        <>
            ...
            <div className="mark-attendance-container">
                ...
                <div className="select-container">
                    ...
                    <Select placeholder="Select Room" options={sectionOptions} styles={customStyles} onChange={(option) => setSectionOptionsPicked(option)} />
                    <Select placeholder="Select Block" options={subjectOptions} styles={customStyles} onChange={(option) => setSubjectOptionsPicked(option)} />
